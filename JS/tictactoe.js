...
let activePlayer = 'X';
//This array stores and array of moves. We us this to determine win conditions.
let selectedSquares = [];

//This function is for placing x or o in a square.
function placeXOrO(squareNumber) {
    //This condition ensures a square hasn't been selected already.
    //This .some() method is used to check each element of selectedSquare array to see
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("./Images/bart.png")';
      //Active player may only be 'X' or 'O' so, if not 'X' it must be 'O' 
        } else {
            //If activePlayer is equal to 'O' 
            select.style.backgroundImage = 'url("./Images/homer.png")';
        }
        //SquareNumber and activePlayerare concatenated together and added to array.
...
//This function parses the selecteSquares array to search for win conditions. 
